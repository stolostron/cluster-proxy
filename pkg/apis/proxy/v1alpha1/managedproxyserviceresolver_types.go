...
// ManagedProxyServiceResolver is the Schema for the managedproxyserviceresolvers API
...
type ManagedProxyServiceResolverSpec struct {
	// +optional
	ManagedClusterSelector *metav1.LabelSelector `json:"managedClusterSelector,omitempty"`
